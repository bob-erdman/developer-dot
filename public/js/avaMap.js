...
function precision(rate, minwidth, precision) {
...
function bubbleContent(content, style) {
   ui.bubble.setValues({
...
*/ 
function resolveAddress(latlng) {
...
function bubbleShow(longitude, latitude) {
